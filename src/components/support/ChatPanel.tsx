...
export default function ChatPanel() {
  ...
  async function send() {
    ...
    // show the user's bubble but DO NOT echo in the assistant
    ...
    try {
      ...
      const assistantText: string =
        typeof json?.content === "string" && json.content.trim()
          ? json.content
          : "Thanks! I can help with routes, pickup points, countries and booking policies. For booking details, please sign in.";
