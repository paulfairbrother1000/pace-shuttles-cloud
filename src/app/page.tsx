...
// helper for type normalization + display
...
/** map normalized type name -> row (for labels/images) */
...
/** compute types from *actual occurrences* (normalized) */
...
/** auto-close Type pane if it adds no value (0 or 1 option) */
useEffect(() => {
