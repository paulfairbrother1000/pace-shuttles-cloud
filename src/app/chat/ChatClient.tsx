...
export default function ChatClient() {
  ...
  return (
    <div className="rounded-xl border border-neutral-800 bg-white/5">
      <div className="max-h-[50vh] overflow-y-auto p-4 space-y-3">
        {turns.length === 0 ? (
          <p className="opacity-75">
            Ask me about destinations, routes, pickups, pricing rules, or how Pace Shuttles works.
          </p>
        ) : (
          turns.map((t, i) => (
      ...
      <div className="flex gap-2 p-3 border-t border-neutral-200 bg-neutral-50">
        <input
          className="flex-1 rounded-lg bg-white text-black border border-neutral-300 px-3 py-2 outline-none"
