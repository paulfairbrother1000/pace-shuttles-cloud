...
export default function VehiclesPage() {
  /* ps_user (to lock operator for operator-admins) */
  ...
  useEffect(() => {
    try {
      ...
      setPsUser(u || null);
      // If operator admin → lock operatorId immediately
  ...
  function resetForm() {
    setEditingId(null);
    // If locked, keep locked operator; else clear it
  ...
  async function onSave(e: React.FormEvent) {
    ...
    try {
      ...
      if (!editingId) {
        // CREATE (admin API already exists & checks types)
        const payload = {
